...
import static com.comphenix.protocol.PacketType.Play.Server.CUSTOM_SOUND_EFFECT;
...
/**
 * Credit to com.comphenix (ProtocolLib) for creating this (https://gist.github.com/aadnk/5871793)
 * <p>
...
public class EntityHider implements Listener {
  ...
  private PacketAdapter constructProtocol(Plugin plugin) {
    return new PacketAdapter(plugin, ENTITY_PACKETS) {
      ...
      public void onPacketSending(PacketEvent event) {
        ...
        if (entityID != null && !PlayerNPCLib.getEntityManager().canSee(event.getPlayer(), entityID) && PlayerNPCLib.isNPC(entityID)
  ...
  public final boolean hideEntity(Player observer, Entity entity) {
    validate(observer, entity);
    return hideEntity(observer, entity.getEntityId());
  }
   ...
   * @return TRUE if the entity was previously visible, FALSE otherwise.
   */
  public final boolean hideEntity(Player observer, int entityId) {
